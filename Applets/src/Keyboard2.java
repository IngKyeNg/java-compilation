/*--------------------------------------------------------------------
Exercise 5B: Keyboard Input

Click, type, and move the mouse. You might see some flickering. Depending on the speed of your computer, you might also find that the mouse position is being sampled too quickly or too slowly.
--------------------------------------------------------------------*/
import java.applet.*;
import java.awt.*;
